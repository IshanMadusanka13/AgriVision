...
const API_URL = Constants.expoConfig?.extra?.apiUrl || 'https://agrivision.duckdns.org';
...
export const fieldAPI = {
  ...
  createField: async (fieldData: {
    ...
    try {
      const response = await fetch(`${API_URL}/api/planting/fields`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  getField: async (fieldId: string) => {
    try {
      const response = await fetch(`${API_URL}/api/planting/fields/${fieldId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const spacingAPI = {
  calculateSpacing: async (soilType: string, climateZone: string) => {
    try {
      const response = await fetch(`${API_URL}/api/planting/spacing/calculate`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const soilAPI = {
  analyzeSoil: async (soilData: {
    ...
    try {
      const response = await fetch(`${API_URL}/api/planting/soil/analyze`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const layoutAPI = {
  generateLayout: async (layoutData: {
    ...
    try {
      const response = await fetch(`${API_URL}/api/planting/layout/generate`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
