...
# Load reference image (done once when service loads)
REFERENCE_IMAGE_PATH = r"D:\Projects\AgriVision\server\app\me.JPG"
...
if os.path.exists(REFERENCE_IMAGE_PATH):
    ...
    # Compute HSV histogram for reference
    ...
    reference_hist = None
    print("⚠ WARNING: Reference image not found at:", REFERENCE_IMAGE_PATH)


async def process_uploaded_image(file):
    """
    Service layer receives FE image and compares it with reference image.
    """
